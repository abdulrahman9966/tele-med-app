...
public class VideoChatActivity extends AppCompatActivity
    ...
    private BootstrapButton callEndBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callEndBtn = (BootstrapButton) findViewById(R.id.callBtn);
    ...
    public void onSessionConnectionDataReady(String apiKey, String sessionId, String token) {
        ...
        myref.child("appointments").child(appointmentId).child("sessionid").setValue(sessionId);
        myref.child("appointments").child(appointmentId).child("token").setValue(token);
    ...
    public void callDisconnect(View view){
        ...
        finish();
        startActivity(new Intent(VideoChatActivity.this,DummyActivity.class));
